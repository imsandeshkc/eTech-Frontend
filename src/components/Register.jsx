    ...
    <section className='h-screen flex items-center justify-center'>
        ...
        <div className='max-w-sm border shadow bg-white mx-auto p-8'>
            ...
            <form onSubmit={handleRegister} className='space-y-5 max-w-sm mx-auto pt-8'>
                ...
                onChange={(e) => setUsername(e.target.value)} placeholder='Username' required className='w-full bg-gray-100 focus:outline-none px-5 py-3' />

                <input type="email" name='email' id='email' 
                onChange={(e) => setEmail(e.target.value)} placeholder='Email ID' required className='w-full bg-gray-100 focus:outline-none px-5 py-3' />
